...
from keras.layers import Conv3D, Input, MaxPooling3D
...
conv1 = Conv3D(nb_filters, (3, 3, 3), activation='relu', padding='same')(input_img)
pool1 = MaxPooling3D(padding="same", pool_size=pool_size)(conv1)
conv2 = Conv3D(nb_filters * 2, (3, 3, 3), activation='relu', padding='same')(pool1)
pool2 = MaxPooling3D(pool_size=pool_size, padding='same')(conv2)
conv3 = Conv3D(nb_filters * 2 * 2, (3, 3, 3), activation='relu', padding='same')(pool2)
pool3 = MaxPooling3D(pool_size=pool_size, padding='same')(conv3)
conv4 = Conv3D(nb_filters * 2 * 2, (3, 3, 3), activation='relu', padding='same')(pool3)
encoded = MaxPooling3D(pool_size=pool_size, padding='same')(conv4)
dropout_1 = Dropout(dropout_rate)(encoded)
...
# dropout_3 = Dropout(dropout_rate)(dense_2)
output = Dense(units=nb_classes, activation='softmax')(dropout_2)
